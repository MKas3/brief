  ...
  return (
    <button
      ...
      className={
        (className ? `${className} ` : '') +
        (isAlt
          ? 'flex w-fit flex-col rounded-xl bg-neutral-900 px-6 hover:bg-neutral-950 disabled:bg-neutral-700 disabled:hover:bg-neutral-700 '
